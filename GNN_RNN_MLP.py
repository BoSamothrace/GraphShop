...
class GNN_RNN_MLP(torch.nn.Module):
    def __init__(self,config):
        super(GNN_RNN_MLP,self).__init__()
        self.layer1=torch.nn.Linear(40,16)
...
# =============================================================================
        vector1=torch.cat([hidden,types],dim=-1)

        vector2=torch.nn.ReLU()(self.layer1(vector1))
        vector3=torch.nn.ReLU()(self.layer2(vector2))
        GNN_RNN_result=torch.nn.ReLU()(self.layer3(vector3))
        return GNN_RNN_result
